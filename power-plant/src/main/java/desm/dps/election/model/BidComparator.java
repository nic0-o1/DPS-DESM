 ...
 * plant with the numerically bigger ID wins.
 */
public final class BidComparator {
    ...
    public static boolean isBetter(Bid candidate, Bid current) {
        ...
        // Any valid bid is better than an empty or null one (represented by plantId 0).
        if (current == null || current.getPlantId() == 0) return true;
